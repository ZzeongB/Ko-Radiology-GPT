...
login(token='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')
...
parser = argparse.ArgumentParser(description='Run the chat model')
parser.add_argument('--model_id', type=str, help='Model ID to use for the chat')
...
if args.model_id:
    ...
    model_id = "h2a0e0u2n/changtongsul"  # default model id
